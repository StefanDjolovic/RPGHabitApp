    ...
    starterSkills: [
      {
        ...
        name: 'Cleave',
        type: 'active',
        description: 'Spend Rage on a dependable heavy strike.',
    ...
    starterSkills: [
      {
        ...
        name: 'Quick Cut',
        type: 'active',
        description: 'Consume Combo Points for a fast finishing cut.',
        equippedByDefault: true,
        slotOrder: 1,
      },
      {
    ...
    starterSkills: [
      {
        ...
        name: 'Shield Bash',
        type: 'active',
        description: 'Spend Guard to strike and blunt the next hit.',
        equippedByDefault: true,
        slotOrder: 1,
      },
      {
